...
public static class RenderUtil
{
    ...
    public static Mesh CreateLineMesh(float3 pos0, float3 pos1)
    {
        Mesh mesh = new Mesh();
    ...
    public static float4x4 GetCfromV_Persp(
        float fov, float aspect, float near, float far, bool toTex = false)
    {
        float4x4 C = float4x4.identity;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float4x4 GetVfromC_Persp(
        float fov, float aspect, float near, float far, bool toTex = false)
    {
        float4x4 V = float4x4.identity;
