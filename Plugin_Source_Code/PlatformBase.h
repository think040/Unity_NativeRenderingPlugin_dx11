...
//	set TARGET_PLUGIN_PATH = $(SolutionDir)..\..\..\UnityProject_NativeRendering\Assets\Plugins\x86
//	) else (
//		set TARGET_PLUGIN_PATH = $(SolutionDir)..\..\..\UnityProject_NativeRendering\Assets\Plugins\x86_64
//		)
